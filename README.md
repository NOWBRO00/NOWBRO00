...
**티끌 모아 풀스택 개발자로** · 멋쟁이사자처럼 13기 · 한서대학교

저와 함께 멋진 프로젝트를 만들어 보세요!

[![GitHub followers](https://img.shields.io/github/followers/NOWBRO00?style=social)](https://github.com/NOWBRO00)
[![Blog](https://img.shields.io/badge/Blog-Naver-03C75D?style=social&logo=naver)](https://blog.naver.com/nowbro00)
...
```text
🌱 티끌 모아 풀스택 개발자로 성장 중입니다.
💻 React · Spring Boot 기반 웹 서비스 개발 경험이 있습니다.
🤝 해커톤, 취업트랙, 팀 프로젝트 등 협업 경험을 쌓아왔습니다.
🚀 사용자 경험을 고민하며 기획부터 배포까지 함께 만듭니다.
```
...
| 프로젝트 | 설명 | 기술 스택 | 링크 |
|:---:|:---|:---|:---:|
| **ROUND & GO** | 제주 골프·여행 통합 서비스. 골프장 검색, AI 코스 추천, 숙소·맛집·관광, 커뮤니티, 일정·날씨, 카카오·이메일 로그인 | `React` `styled-components` `axios` `Kakao Map` `TourAPI` | [Frontend](https://github.com/NOWBRO00/RoundAndGo_Frontend) |
| **Localy** | 13기 아기사자 취업트랙(Pawket). 로컬 탐험·미션·챌린지·채팅·대시보드 기반 지역 커뮤니티 앱 | `React 19` `Vite` `styled-components` `STOMP` `Recharts` | [Frontend](https://github.com/NOWBRO00/likelion-localy-frontend) |
...
```
🦁 멋쟁이사자처럼 13기         프론트엔드 · 풀스택 프로젝트
🏫 대학교동아리 활동           해커톤 · 취업트랙 · 팀 프로젝트
🎣 팀 일편단심                고래밥 — 낚시 예약·커뮤니티 플랫폼
⛳ ROUND & GO                 제주 골프·여행 서비스(관광데이터 활용 공모전 수상)
🛒 Ssak3                      교내 중고거래·심부름 플랫폼
```
...
<a href="https://blog.naver.com/nowbro00">
  <img src="https://img.shields.io/badge/Naver_Blog-03C75D?style=for-the-badge&logo=naver&logoColor=white"/>
</a>
<a href="mailto:wogud879@gmail.com">
  <img src="https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/>
</a>
<a href="https://github.com/NOWBRO00">
...
![Visitor Count](https://visitor-badge.laobi.icu/badge?page_id=NOWBRO00.NOWBRO00&left_color=4CAF50&right_color=2E7D32)
